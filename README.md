...
### Compiling error workarounds

#### 'string' file not found
Remove the following lines from `yoga-umbrella.h`
```
...
Explicitly add casting `(uint32_t)`

#### Cannot find `Folly` while `pod install`
Add the following to Podfile before `React`
...
#### 'RCTTVRemoteHandler.h' file not found
Add `tvOS` as `React`'s dependency
